<footer>
    ...
    <p style="font-size: 17px">
        Discover the Unparalleled Collection: At AD Motors Store, we believe that every rider deserves the best
        two-wheeled
    ...
    <b> AD Motors Store </b></a> <br>

    <a style="color:white" href="https://youtube.com/"><i class="fa-brands fa-youtube"></i></a>
    ...
    <i class="fa-regular fa-copyright mt-3"> <span style="font-size: 17px;">2023 - AD Motors Store </span></i>
