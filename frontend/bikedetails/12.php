      ...
      <div class="row">
        <div class="col-md-6 proimg">
          ...
          <div class="purchase-info">
            <?php $product_name = 'Honda CB Hornet 160R' ?>
        ...
        <div class="col-md-6 specs">
          ...
          <div class="last-price">
            Old Price: <span>Rs.375,00,000/-</span>
          </div>
          <div class="product-price">
            New Price: <span>Rs.4,00,000/-</span>
          </div>
          <div class="purchase-info">
            <form action="../../backend/orders.php?ordered_bike=12" method="post">
