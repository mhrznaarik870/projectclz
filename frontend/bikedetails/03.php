      ...
      <div class="row">
        <div class="col-md-6 proimg">
          ...
          <div class="purchase-info ">
            ...
            <?php $product_name = 'MT-15 V-2.0' ?>
            <?php $product_price = 'Rs.3,00,000/-' ?>
                               ...
                               <li>Bore: 58.0 mm</li>
                                 <li>Stroke: 58.7 mm</li>
                                   <li>Compression Ratio: 11.6 :1</li>
                                     ...
                                     <div class="last-price">Old Price: <span>Rs.3,10,000/-</spa
            n></div>

              <div class="product-price">
              New Price: <span>Rs.3,00,000/-</span>
              </div>
            <div class="purchase-info">
             <form action="../../backend/orders.php?ordered_bike=MT-15 V-2.0" method="post">
