    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 proimg">
          <div class="proimg">
            <img src="./assets/img/products/10.jpg" alt="Honda Xblade" class="img-fluid" />
          </div>
        ...
        <div class="col-md-6 specs">
          ...
          <div class="old-price">
            <?php
            $sql = "SELECT old_price FROM products WHERE bike_id=10";
          ...
          <div class="new-price">
            <?php
            $sql = "SELECT new_price FROM products WHERE bike_id=10";
            $result = $conn->query($sql);
